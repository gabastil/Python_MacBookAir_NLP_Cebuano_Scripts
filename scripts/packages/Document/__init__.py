"""
document	contains code to open and manipulate text and spreadsheet (i.e., csv, tsv, etc.) documents.

	<< YOU HAVE TO EDIT THE REST OF THIS DOCUMENT. IT STILL BELONGS TO PARSE. >>
