...
class Distance(object):
	...
	def euclidian(self, point1, point2):
		""" 
			euclidian() counts the euclidian distance between point1 and point2. Returns a scalar integer. 
...
if __name__ == "__main__":
	...
	for f in f0:
		...
		for ff in f0:
				...
				#print f[-1]
				#print "euclidian distance: {0}".format(a)
